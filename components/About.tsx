...
const About = async () => {
    return (
        <div className="h-lvh pt-44 p-10 z-10 space-y-16 m-auto max-w-7xl w-full">
            <div>
                <div>About</div>
                <div className="line border-t-2 border-t-gray-400 p-5"></div>
            </div>
            <div>
                <AnimatedText className="text-7xl font-bold max-w-4xl" text="I build and design" />
                <AnimatedText className="text-7xl font-bold max-w-4xl" text="custom websites" />
                <AnimatedText className="text-7xl font-bold max-w-4xl" text="that are playful & fun" />
            </div>
